...
describe("New Board", function() {
    ...
    it("should throw an error if the passed in layout is invalid", function(done) {
        expect(Board.bind(Board, "---n-----")).to.throw("Invalid square in board");
        done();
    });
    it("should throw an error if the passed in board is an invalid type", function(done) {
        expect(Board.bind(Board, 8)).to.throw("Invalid type for layout");
        done();
    });
});
...
describe("Player Set Square", function() {
    ...
    it("should not allow an X to be placed at the designated location (1, 1)", function(done) {
        ...
        expect(board.SetSquare(new Player("X", "human"), 1, 1)).to.be.false;
        done();
    });
    it("should throw an error if there is no row specified", function(done) {
        var board = new Board();
        expect(board.SetSquare.bind(board, new Player("X", "human"))).to.throw("Row or Column is invalid");
        done();
    });
    it("should throw an error if there is no column specified", function(done) {
        var board = new Board();
        expect(board.SetSquare.bind(board, new Player("X", "human"), 1)).to.throw("Row or Column is invalid");
        done();
    });
    it("should throw an error if the row is out of range > 2", function(done) {
        var board = new Board();
        expect(board.SetSquare.bind(board, new Player("X", "human"), 4, 0)).to.throw("Row or Column is invalid");
        done();
    });
    it("should throw an error if the column is out of range > 2", function(done) {
        var board = new Board();
        expect(board.SetSquare.bind(board, new Player("X", "human"), 0, 4)).to.throw("Row or Column is invalid");
        done();
    });
    it("should throw an error if the row is out of range < 0", function(done) {
        var board = new Board();
        expect(board.SetSquare.bind(board, new Player("X", "human", -1, 0))).to.throw("Row or Column is invalid");
        done();
    });
    it("should throw an error if the column is out of range < 0", function(done) {
        var board = new Board();
        expect(board.SetSquare.bind(board, new Player("X", "human"), 0, -2)).to.throw("Row or Column is invalid");
        done();
    });
    ...
    it("should throw an error if the column is an invalid type (NaN)", function(done) {
        var board = new Board();
        expect(board.SetSquare.bind(board, new Player("X", "human"), 0, NaN)).to.throw("Row or Column is invalid");
        done();
    });
    it("should throw an error if the row is an invalid type (float)", function(done) {
        var board = new Board();
        expect(board.SetSquare.bind(board, new Player("X", "human"), 1.4, 0)).to.throw("Row or Column is invalid");
        done();
    });
...
describe("Get square", function() {
    ...
    it("should throw an error if the row is out of range > 2", function (done) {
        var board = new Board();
        expect(board.GetSquare.bind(board, new Player("X", "human"), 4, 0)).to.throw("Row or Column is invalid");
        done();
    });
    it("should throw an error if the column is out of range > 2", function (done) {
        var board = new Board();
        expect(board.GetSquare.bind(board, new Player("X", "human"), 0, 4)).to.throw("Row or Column is invalid");
        done();
    });
    it("should throw an error if the row is out of range < 0", function (done) {
        var board = new Board();
        expect(board.GetSquare.bind(board, new Player("X", "human"), -1, 0)).to.throw("Row or Column is invalid");
        done();
    });
    it("should throw an error if the column is out of range < 0", function (done) {
        var board = new Board();
        expect(board.GetSquare.bind(board, new Player("X", "human"), 1, -2)).to.throw("Row or Column is invalid");
        done();
    });
    it("should throw an error if the row is an invalid type (string)", function (done) {
        var board = new Board();
        expect(board.GetSquare.bind(board, new Player("X", "human"), "2", 0)).to.throw("Row or Column is invalid");
        done();
    });
    it("should throw an error if the row is an invalid type (NaN)", function (done) {
        var board = new Board();
        expect(board.GetSquare.bind(board, new Player("X", "human"), NaN, 0)).to.throw("Row or Column is invalid");
        done();
    });
    it("should throw an error if the row is an invalid type (float)", function (done) {
        var board = new Board();
        expect(board.GetSquare.bind(board, new Player("X", "human"), 1.2, 0)).to.throw("Row or Column is invalid");
        done();
    });
    it("should throw an error if the column is an invalid type (string)", function (done) {
        var board = new Board();
        expect(board.GetSquare.bind(board, new Player("X", "human"), 1, "1")).to.throw("Row or Column is invalid");
        done();
    });
    it("should throw an error if the column is an invalid type (NaN)", function(done) {
        var board = new Board();
        expect(board.GetSquare.bind(board, new Player("X", "human"), 1, NaN)).to.throw("Row or Column is invalid");
        done();
    });
    it("should throw an error if the column is an invalid type (float)", function(done) {
        var board = new Board();
        expect(board.GetSquare.bind(board, new Player("X", "human"), 1, 0.8)).to.throw("Row or Column is invalid");
        done();
    });
